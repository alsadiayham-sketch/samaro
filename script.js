...
var cart = normalizeCartItems(JSON.parse(localStorage.getItem('samaro_cart') || '[]'), normalizeProducts(DEFAULT_PRODUCTS));
var deliveryMethod = localStorage.getItem('samaro_delivery_method') || 'delivery';
...
function saveCart() {
    localStorage.setItem('samaro_cart', JSON.stringify(normalizeCartItems(cart, products.length ? products : normalizeProducts(DEFAULT_PRODUCTS))));
}

function setDeliveryMethod(method) {
    deliveryMethod = method;
    localStorage.setItem('samaro_delivery_method', method);
